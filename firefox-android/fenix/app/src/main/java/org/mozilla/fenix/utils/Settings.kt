...
class Settings(private val appContext: Context) : PreferencesHolder {
    ...
    companion object {
        ...
        private const val INACTIVE_TAB_MINIMUM_TO_SHOW_AUTO_CLOSE_DIALOG = 2000
         ...
         */
        @VisibleForTesting
        internal var SEARCH_GROUP_MINIMUM_SITES: Int = 2000
    ...
    internal val isCrashReportEnabledInBuild: Boolean =
        BuildConfig.CRASH_REPORTING && Config.channel.isDebug
    ...
    val isCrashReportingEnabled by booleanPreference(
    ...
    var showSecretDebugMenuThisSession = true
     ...
     */
    fun checkIfFenixIsDefaultBrowserOnAppResume() = true
    ...
    fun shouldOpenLinksInApp() = false
     ...
     */
    fun shouldPromptOpenLinksInApp() = false
    ...
    val frecencyFilterQuery by stringPreference(
        ...
        default = "", // Parameter provided by adM
    )
    ...
    var enableTabsTrayToCompose by booleanPreference(
        appContext.getPreferenceKey(R.string.pref_key_enable_tabs_tray_to_compose),
        default = true,
    )
    ...
    var enableComposeTopSites by booleanPreference(
        appContext.getPreferenceKey(R.string.pref_key_enable_compose_top_sites),
        default = true,
    )
