   ...
   // val adsTelemetry by lazyMonitored {
    ...
    val contileTopSitesUpdater by lazyMonitored {
        ContileTopSitesUpdater(
            ...
            frequency = Frequency(99999999000000, TimeUnit.HOURS),
        )
    }
    ...
    companion object {
        ...
        private const val RECENTLY_CLOSED_MAX = 25
        const val HISTORY_METADATA_MAX_AGE_IN_MS = 1 * 24 * 60 * 60 * 1000 // 14 days
        private const val CONTILE_MAX_CACHE_AGE = 36000000L // 60 minutes
