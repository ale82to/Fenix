...
class BrowserToolbarView(
    ...
    init {
        ...
        with(context) {
            ...
            view.apply {
                ...
                val securityIconSecureColor = 0xFF232323.toInt()
                val securityIconinSecureColor = 0xFF292929.toInt()
                display.urlFormatter = { url -> URLStringUtils.toDisplayUrl(url) }
                

                display.colors = display.colors.copy(
                    text = separatorColor,
                    securityIconSecure = securityIconSecureColor,
                    securityIconInsecure = securityIconinSecureColor,
                    menu = separatorColor,
    ...
    private fun ToolbarMenu.Item.performHapticIfNeeded(view: View) {
        if (this is ToolbarMenu.Item.Reload && this.bypassCache ||
            ...
            this is ToolbarMenu.Item.Stop ||
            this is ToolbarMenu.Item.FindInPage
        ) {
