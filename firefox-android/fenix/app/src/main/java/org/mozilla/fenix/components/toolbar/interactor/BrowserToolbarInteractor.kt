...
interface BrowserToolbarInteractor {
    fun onTabCounterClicked(closeTab: TabCounterMenu.Item.CloseTab)
...
class DefaultBrowserToolbarInteractor(
    ...
    override fun onTabCounterClicked(closeTab: TabCounterMenu.Item.CloseTab) {
    ...
    override fun onBrowserToolbarPaste(text: String) {
        ...
        menuController.handleToolbarItemInteraction(ToolbarMenu.Item.AddToHomeScreen)
    }
   ...
   // override fun onHomeButtonClicked() {
       // menuController.handleToolbarItemInteraction(ToolbarMenu.Item.Downloads)
   // }
