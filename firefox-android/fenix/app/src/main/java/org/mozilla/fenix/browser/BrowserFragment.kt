    ...
    override fun initializeUI(view: View, tab: SessionState) {
        ...
        val leadingAction = if (isPrivate && context.settings().feltPrivateBrowsingEnabled) {
            ...
            BrowserToolbar.Button(
                ...
                iconTintColorResource = ThemeManager.resolveAttribute(R.attr.textDisabled, context),
                longClickListener = {
        ...
        val translationsAction =
            BrowserToolbar.ToggleButton(
                image = AppCompatResources.getDrawable(
                    ...
                    setTint(ContextCompat.getColor(context, R.color.fx_mobile_text_color_disabled))
                },
        ...
        binding.tabStripView.apply {
            ...
            setContent {
                FirefoxTheme {
                    TabStrip(
                        // ... other parameters ...
                       // onAddTabClick = { tab, sitePermissions -> navToQuickSettingsSheet(tab, sitePermissions)},
...
@VisibleForTesting
internal fun updateToolbarActions() {
    addTabletActions(requireContext())
}
    ...
    private fun addTabletActions(context: Context) {
        val enableTint = ThemeManager.resolveAttribute(R.attr.borderPrimary, context)
        ...
        if (backAction == null) {
            backAction = BrowserToolbar.TwoStateButton(
                ...
                listener = {
                    browserToolbarInteractor.onTabCounterMenuItemTapped(TabCounterMenu.Item.CloseTab)
        ...
        if (refreshAction == null) {
            refreshAction = BrowserToolbar.TwoStateButton(
                ...
                primaryImageTintResource = R.color.photonViolet70,
                isInPrimaryState = {
                ...
                listener = {
                    if (getCurrentTab()?.content?.loading == true) {
                        ...
                        browserToolbarInteractor.onBrowserToolbarMenuItemTapped(
                            ToolbarMenu.Item.RemoveFromTopSites
                        )
                    }
                }
            )
