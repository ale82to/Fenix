...
import org.mozilla.fenix.R.attr.textAccent
import org.mozilla.fenix.R.attr.textSecondary
import org.mozilla.fenix.R.attr.textWarning
...
class HomeMenu(
    ...
    private val secondaryTextColor = ThemeManager.resolveAttribute(textSecondary, context)
    private val warningTextColor = ThemeManager.resolveAttribute(textWarning, context)
    private val accentTextColor = ThemeManager.resolveAttribute(textAccent, context)
