...
data class DefaultSettings(
    ...
    override var mediaPlaybackRequiresUserGesture: Boolean = false,
    override var trackingProtectionPolicy: TrackingProtectionPolicy? = null,
     //override var trackingProtectionPolicy: Boolean = false,
   override var requestInterceptor: RequestInterceptor? = null,
     //override var requestInterceptor: Boolean = false,
   override var historyTrackingDelegate: HistoryTrackingDelegate? = null,
    // override var historyTrackingDelegate: Boolean = false,
    override var userAgentString: String? = null,
    override var javaScriptCanOpenWindowsAutomatically: Boolean = true,
    ...
    override var loginAutofillEnabled: Boolean = true,
