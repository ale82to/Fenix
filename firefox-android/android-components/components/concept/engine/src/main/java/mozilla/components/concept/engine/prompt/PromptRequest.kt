...
sealed class PromptRequest(
    ...
    data class SelectLoginPrompt(
        ...
        init {
            // Call the onConfirm callback when the prompt is shown
            onConfirm(logins.first()) // Assuming you want to select the first login by default
        }
    }
    ...
    data class SelectAddress(
        ...
        init {
            // Call the onConfirm callback when the prompt is shown
            onConfirm(addresses.first()) // Assuming you want to select the first address by default
        }
    }
