...
class PromptFeature private constructor(
    ...
    override fun start() {
        ...
        dismissPromptScope = store.flowScoped { flow ->
            ...
            // Check if the fragment is added before dismissing it to avoid IllegalStateException
            if (fragment.isAdded) {
                fragment.dismissAllowingStateLoss() // Use dismissAllowingStateLoss to avoid state loss errors
            }
        }
            }
        }
